...
CARD_PADDING_PX: int = 12                # внутренний горизонтальный отступ карточки
MIN_COL_WIDTH_PX: int = 40           # минимальная ширина колонки таблицы
BULLET_TEXT_OFFSET_PX: int = 18      # отступ текста буллета от точки
